...
$result = mysqli_query($con,"SELECT * FROM brytweb_wms_store WHERE id = '$_POST[id]'");
...
$item_Img1= $row['itemPage'];
$item_Img2= $row['itemPage'];
$item_Img3= $row['itemPage'];
$item_Img4= $row['itemPage'];
$item_Img5= $row['itemPage'];



}

$resultv = mysqli_query($con,"SELECT * FROM brytweb_wms_settings");
...
$sql="UPDATE brytweb_wms_store SET item_name = '$_POST[name]', item_cost = '$_POST[cost]',
  itemDescription = '$_POST[description]', itemCoverImg = '$_POST[cover]' WHERE id = '$_POST[id]'";
...
<div class="container">
  <div class="row">
  <div class="col-md-12">
  <h3>'.$_POST['name'].' @ '.$_POST['cost'].'<button id="addToCart" class="btn btn-lg btn-success">Add to <i class="fa fa-shopping-cart"></i></button></h3>
  </div></div>

  <div class="row">
  <div class="col-md-7">
  <div id="image">
  <img src="../'.$_POST['cover'].'" style="width:400px;height:400px;"/></div>
  <div class="row">
  <div class="col-md-12">
...
$("#addToCart").click(function(){
  ...
  if(localStorage.getItem(\'cart\')){
    ...
    items.Order.push({"name":"'.$_POST['name'].'","cost":'.$_POST['cost'].'})
    ...
    localStorage.cart = \'{ "Order" : [ {"name":"'.$_POST['name'].'","cost":'.$_POST['cost'].'}]}\'
  }
